...
import type { Timer, TimerCreationRequest, TimerCreationResponse, TimerLoginResponse, TimerUpdateRequest } from "types/timer";
...
const loginTimer = async (id: string, password: string, fetch: Fetch): Promise<TimerLoginResponse> => {
...
const updateTimer = async (id: string, newTimerData: TimerUpdateRequest, token: string, fetch: Fetch) => {
...
const createTimer = async (timerData: TimerCreationRequest, fetch: Fetch): Promise<TimerCreationResponse> => {
