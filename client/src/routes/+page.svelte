...
<div class="m-auto items-center grid gap-5 pt-10 p-4">
	...
	<div class="card p-4 w-full md:w-[70%] lg:w-[50%] m-auto grid gap-2 grid-cols-2">
		...
		<a href="/manage/create" class="btn btn-sm variant-filled-secondary col-span-2 md:col-span-1"
			>Create a new timer</a
		>
		<a href="/manage/login" class="btn btn-sm variant-filled-tertiary col-span-2 md:col-span-1"
			>Manage an existing timer</a
		>
	</div>

	{#if instanceProperties.demo || instanceProperties.donation}
		<div class="card p-4 md:w-[70%] lg:w-[50%] m-auto">
